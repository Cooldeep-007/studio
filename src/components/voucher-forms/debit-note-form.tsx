...
type FormValues = z.infer<typeof debitNoteSchema>;
...
export function DebitNoteForm() {
    ...
    function onSubmit(data: FormValues) {
        ...
        toast({
            ...
            description: 'The purchase return voucher has been successfully saved.',
        });
        ...
        <>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-6">
                    <Card>
                        <CardHeader>
                            <CardTitle>New Debit Note (Purchase Return)</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex justify-end">
                                <div className="w-full max-w-sm space-y-2 text-sm">
                                    ...
                                    <Separator />
                                    <div className="flex justify-between text-lg font-bold"><span>Total Debit</span><span>{formatCurrency(calculations.grandTotal)}</span></div>
                                </div>
                            </div>
                        </CardContent>
                        <CardFooter>
                            <Button type="submit" disabled={form.formState.isSubmitting}>Create Debit Note</Button>
                        </CardFooter>
                    </Card>
                </form>
            </Form>
            ...
            <AddItemSheet open={isAddItemSheetOpen} onOpenChange={setIsAddItemSheetOpen} onItemCreated={handleItemCreated} />
        </>
    );
}
