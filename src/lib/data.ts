...
export const mockLedgers: Ledger[] = [
  ...
  // =================================================================
  {
    id: 'led-opening-balance-equity',
    ledgerName: 'Opening Balance Equity',
    ...
    currentBalance: 0,
    balanceType: 'Cr',
    isSystem: true, // Mark as a system ledger
    gstApplicable: false,
    status: 'Active',
    createdAt: new Date(MOCK_DATA_YEAR, 3, 1),
    lastUpdatedAt: new Date(MOCK_DATA_YEAR, 3, 1),
  ...
  },
  {
    id: 'led-cash',
    ledgerName: 'Cash in Hand',
    parentLedgerId: 'group-cash-in-hand',
    group: 'Cash-in-Hand',
    nature: 'Asset',
    isGroup: false,
    isCashAccount: true,
  ...
  {
    id: 'led-icici',
    ledgerName: 'ICICI Bank - XXXX3456',
    parentLedgerId: 'group-bank-accounts',
    group: 'Bank Accounts',
    nature: 'Asset',
    isGroup: false,
